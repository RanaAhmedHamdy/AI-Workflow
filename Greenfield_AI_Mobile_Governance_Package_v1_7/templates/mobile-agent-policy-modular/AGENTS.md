...
- `.agents/policies/PROTECTED_BOUNDARIES.md`
- `.agents/policies/EVIDENCE_AND_COMPLETION.md`

For implementation work, also read:

- `.agents/policies/IMPLEMENTATION_POLICY.md`

For Android work:

- `.agents/policies/android/ANDROID_ENGINEERING_POLICY.md`

For iOS work:

- `.agents/policies/ios/IOS_ENGINEERING_POLICY.md`

Use `AI_CONTEXT.md` to route applicable skills, ADRs, design contracts, evidence, and platform policy.
