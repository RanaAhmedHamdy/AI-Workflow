...
|---|---|---|
| Skill index | `.agents/skills/README.md` | Active routing |
...
| Production integrity | `.agents/skills/shared/production-fake-detection/SKILL.md` | Mandatory before implementation and merge readiness |
| Documentation consistency | `.agents/skills/shared/documentation-consistency-review/SKILL.md` | Mandatory when current artifacts may conflict |
| Architecture coverage | `.agents/skills/shared/architecture-coverage-review/SKILL.md` | Mandatory after material planning |
| Protected boundary | `.agents/skills/shared/protected-boundary-preflight/SKILL.md` | Mandatory before protected changes |
| Documentation impact | `.agents/skills/shared/documentation-impact-assessment/SKILL.md` | Mandatory before finalizing plans and after implementation |
| PR review | `.agents/skills/shared/pr-review/SKILL.md` | Mandatory before readiness |
