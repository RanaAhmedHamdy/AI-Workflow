...
This skill reviews implementation and evidence. It does not approve the feature, authorize release, authorize distribution, or silently repair product or architecture drift.
...
`.templates/mobile/READINESS_REPORT_TEMPLATE.md`
