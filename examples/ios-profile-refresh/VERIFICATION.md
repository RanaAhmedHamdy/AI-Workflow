...
| `xcodebuild … test` | PASS | Executed 2026-08-25 on an iPhone 17 Pro simulator; 2 XCTest cases passed (testMissingFileReturnsExplicitLegacyFallback, testPersistedDisplayNameRoundTrips). |
