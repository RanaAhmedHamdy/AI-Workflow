...
|---|---|---|
| Architecture bootstrap | `.agents/skills/ios/architecture-bootstrap/SKILL.md` | Run before bounded feature intake; resumable after owner decisions/evidence |
| ADR lifecycle | `.agents/skills/ios/adr-lifecycle-governance/SKILL.md` | Required for ADR status promotion/amendment/provisional/supersession |
...
| Architecture coverage | `.agents/skills/ios/architecture-coverage-review/SKILL.md` | Bootstrap/feature/convergence modes; run after material architecture or planning changes |
