...
description: "Independently reviews the final iOS feature state, readiness report, and evidence package for owner acceptance. Use after implementation convergence to decide PASS, FAIL, BLOCKED, owner-decision, or verification status without authorizing release or distribution."
---
...
- design-bound task records show the exact visual was inspected before UI code and the approved Design Lock/permitted adaptations remained authoritative;
...
A dedicated screenshot/fidelity comparison is optional unless explicitly required by approved evidence policy, task/plan, owner concern, regression risk, or final readiness.
