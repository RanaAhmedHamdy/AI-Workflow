...
- for a design-bound screen, the exact approved visual artifact/variant is identified, inspectable, and required for pre-code inspection;
- the Design Lock preserves composition/hierarchy/grouping/action placement unless a documented permitted adaptation applies;
