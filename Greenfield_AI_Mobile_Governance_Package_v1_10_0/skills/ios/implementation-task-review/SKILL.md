...
- design binding classification;
- exact approved compact visual artifact/path or deterministic locator;
- exact wide/other variant where applicable;
- design-bound tasks carry a concise Design Lock and explicit pre-code visual-inspection requirement;
- the visual is actually inspectable; Markdown-only traceability is insufficient;
- supported states;
- error/recovery;
- exclusions;
