...
- the implementation agent must inspect that visual before UI code; Markdown descriptions do not substitute for it;
- Design Lock and only permitted platform/accessibility/localization/responsive/owner-approved adaptations are explicit;
