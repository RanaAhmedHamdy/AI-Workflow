...
4. For design-bound UI, cite and inspect the exact approved compact/wide visual artifacts and record a concise Design Lock (binding composition/hierarchy/grouping/action placement + permitted adaptations); IDs alone are not sufficient visual input.
