...
`.templates/mobile/android/IMPLEMENTATION_PLAN_TEMPLATE.md`
...
- cite and inspect exact approved compact, medium, and expanded visual artifacts as applicable;
- for design-bound UI, record a concise Design Lock (binding composition/hierarchy/grouping/action placement + permitted adaptations); artifact IDs alone are not sufficient visual input;
