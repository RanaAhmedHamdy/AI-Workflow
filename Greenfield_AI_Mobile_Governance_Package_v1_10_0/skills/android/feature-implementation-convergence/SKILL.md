...
description: "Audits a completed Android feature against the approved contract, implementation plan, tasks, architecture, design, cross-cutting requirements, and evidence. Use after implementation to detect drift before owner acceptance; it does not authorize release."
---
...
- design-bound tasks recorded pre-code inspection and preserved their approved Design Lock/permitted adaptations;
...
Do not require a new screenshot-diff artifact solely for convergence unless the Plan/Task, owner, risk, or final-readiness policy explicitly requires visual comparison.
