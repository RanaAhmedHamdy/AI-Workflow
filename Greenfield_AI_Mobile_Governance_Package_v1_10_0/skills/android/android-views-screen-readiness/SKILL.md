...
- exact approved visual artifact/variant for design-bound screens
- Activity/Fragment/ViewModel ownership
- navigation and lifecycle plan
- resources, RTL, adaptive, and accessibility requirements

## Checks
- design-bound screens require actual pre-code inspection of the exact approved visual; Markdown-only interpretation is insufficient
- preserve the Design Lock; material redesign needs a documented permitted adaptation or owner approval
