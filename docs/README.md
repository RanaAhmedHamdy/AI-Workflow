...
Choose the shortest route to your goal.

| I want to… | Start here |
| --- | --- |
| Try it safely in five minutes | [Quickstart](QUICKSTART.md) |
| Understand the Android and iOS examples | [Examples](../examples/README.md) |
...
| Evaluate public claims | [Public claims matrix](PUBLIC_CLAIMS.md) |
| Understand versions and future v1 compatibility | [Versioning](VERSIONING.md) and [v1 support policy](V1_SUPPORT_POLICY.md) |
