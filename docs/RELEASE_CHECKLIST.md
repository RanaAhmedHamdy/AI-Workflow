...
- [ ] Local repository validation, unit tests, and relevant Android/iOS fixture checks pass.
...
- [ ] Anonymous browser can open the repository, README, tags, Issues,
...
- [ ] The selected PyPI publishing method is configured and requires maintainer
...
- [ ] The owner verifies the tag/version match before creating the release.
...
- [ ] Installation, routing, profile, native-fixture, and documentation feedback is logged.
